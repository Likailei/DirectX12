...
void Game::LoadPipeline() {
    ...
    // Descriptor heaps.
    {
        ...
        cbvSrvHeapDesc.NumDescriptors = NUM_TEXTURE + FrameCount * m_region.GetChunks().size();
...
void Game::LoadAssets() {
    ...
    {
        UINT vSize = m_chunk.GetChunkMesh().v.size() * sizeof(Vertex);
        UINT iSize = m_chunk.GetChunkMesh().i.size() * sizeof(UINT);
        ...
        vertexData.pData = (UINT8*)(m_chunk.GetChunkMesh().v.data());
        ...
        indexData.pData = (UINT8*)(m_chunk.GetChunkMesh().i.data());
    ...
    // Constant buffer view.
    {
        ...
        UINT bufferCount = (m_region.GetChunks().size() + cbCountInBufferStep - 1) / cbCountInBufferStep;
        ...
        for (UINT8 i = 0; i < FrameCount; i++) {
            ...
            UINT64 offset = 0;
            for (UINT n = 0; n < m_region.GetChunks().size(); n++) {
...
void Game::InitBundles() {
    ...
    CD3DX12_GPU_DESCRIPTOR_HANDLE cbvHandle(m_cbvSrvHeap->GetGPUDescriptorHandleForHeapStart(), NUM_TEXTURE + m_frameIndex * m_region.GetChunks().size(), m_cbuDescSize);
    ...
    for (UINT8 i = 0; i < FrameCount; i++) {
        ...
        unsigned mm[] = { 221,  221,  221, 221, 237, 103 };
        m_bundles[i]->SetGraphicsRoot32BitConstants(2, 6, mm, 0);
        
            m_bundles[i]->SetGraphicsRootDescriptorTable(1, cbvHandle);
            m_bundles[i]->DrawIndexedInstanced(m_chunk.GetChunkMesh().i.size(), 1, 0, 0, 0);
...
//                //front face
//                if (Z == startZ) {
//                    blockIndices.push_back(0 + 24 * BlockCnt);
//                    blockIndices.push_back(1 + 24 * BlockCnt);
//                    blockIndices.push_back(2 + 24 * BlockCnt); // first triangle
//                    blockIndices.push_back(0 + 24 * BlockCnt);
//                    blockIndices.push_back(3 + 24 * BlockCnt);
//                    blockIndices.push_back(1 + 24 * BlockCnt); // second triangle
//                }
//
//                //left face                
//                if (X == startX) {
//                    blockIndices.push_back(4 + 24 * BlockCnt);
//                    blockIndices.push_back(5 + 24 * BlockCnt);
//                    blockIndices.push_back(6 + 24 * BlockCnt); // first triangle
//                    blockIndices.push_back(4 + 24 * BlockCnt);
//                    blockIndices.push_back(7 + 24 * BlockCnt);
//                    blockIndices.push_back(5 + 24 * BlockCnt); // second triangle
//                }
//
//                //right face
//                if (X == -startX) {
//                    blockIndices.push_back(8 + 24 * BlockCnt);
//                    blockIndices.push_back(9 + 24 * BlockCnt);
//                    blockIndices.push_back(10 + 24 * BlockCnt); // first triangle
//                    blockIndices.push_back(8 + 24 * BlockCnt);
//                    blockIndices.push_back(11 + 24 * BlockCnt);
//                    blockIndices.push_back(9 + 24 * BlockCnt); // second triangle
//                }
//                
//                //back face
//                if (Z == -startZ) {
//                    blockIndices.push_back(12 + 24 * BlockCnt);
//                    blockIndices.push_back(13 + 24 * BlockCnt);
//                    blockIndices.push_back(14 + 24 * BlockCnt); // first triangle
//                    blockIndices.push_back(12 + 24 * BlockCnt);
//                    blockIndices.push_back(15 + 24 * BlockCnt);
//                    blockIndices.push_back(13 + 24 * BlockCnt); // second triangle
//                }
//
//                //top face
//                if (Y == endY) {
//                    blockIndices.push_back(16 + 24 * BlockCnt);
//                    blockIndices.push_back(17 + 24 * BlockCnt);
//                    blockIndices.push_back(18 + 24 * BlockCnt); // first triangle
//                    blockIndices.push_back(16 + 24 * BlockCnt);
//                    blockIndices.push_back(19 + 24 * BlockCnt);
//                    blockIndices.push_back(17 + 24 * BlockCnt); // second triangle
//                }
//
//                //bottom face
//                if (Y == startY) {
//                    blockIndices.push_back(20 + 24 * BlockCnt);
//                    blockIndices.push_back(21 + 24 * BlockCnt);
//                    blockIndices.push_back(22 + 24 * BlockCnt); // first triangle
//                    blockIndices.push_back(20 + 24 * BlockCnt);
//                    blockIndices.push_back(23 + 24 * BlockCnt);
//                    blockIndices.push_back(21 + 24 * BlockCnt); // second triangle
//                }
//                
//                ++BlockCnt;
//            }
...
void Game::OnUpdate() {
    ...
    XMMATRIX world;
    for (UINT n = 0; n < 1; n++) {
        world = XMMatrixTranslationFromVector(XMLoadFloat3(&m_chunk.GetChunkPosition()));
